  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	c7 04 24 7c 04 00 00 	movl   $0x47c,(%esp)
  50:	e8 8b 01 00 00       	call   1e0 <strlen>
  55:	b9 7c 04 00 00       	mov    $0x47c,%ecx
  ...
  e2:	c3                   	ret    
  write(fd, s, strlen(s));
  e3:	c7 04 24 87 04 00 00 	movl   $0x487,(%esp)
  ea:	e8 f1 00 00 00       	call   1e0 <strlen>
  ef:	ba 87 04 00 00       	mov    $0x487,%edx
 ...
 108:	e8 b6 02 00 00       	call   3c3 <exit>
  write(fd, s, strlen(s));
 10d:	c7 04 24 9b 04 00 00 	movl   $0x49b,(%esp)
 114:	e8 c7 00 00 00       	call   1e0 <strlen>
 119:	c7 44 24 04 9b 04 00 	movl   $0x49b,0x4(%esp)
 120:	00 
 ...
 131:	e8 8d 02 00 00       	call   3c3 <exit>
  write(fd, s, strlen(s));
 136:	c7 04 24 bc 04 00 00 	movl   $0x4bc,(%esp)
 13d:	e8 9e 00 00 00       	call   1e0 <strlen>
 142:	c7 44 24 04 bc 04 00 	movl   $0x4bc,0x4(%esp)
 149:	00 
