...
main(int argc, char *argv[])
{
  ...
  3d:	c7 44 24 04 df 07 00 	movl   $0x7df,0x4(%esp)
  44:	00 
 ...
 397:	89 d1                	mov    %edx,%ecx
{
 ...
 3e5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 3e8:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5f3:	bb fb 07 00 00       	mov    $0x7fb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	75 d6                	jne    68f <free+0x4f>
  freep = p;
 6b9:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
 ...
 77c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 77f:	a3 9c 0a 00 00       	mov    %eax,0xa9c
      return (void*)(p + 1);
 ...
 78f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 790:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
 795:	ba a0 0a 00 00       	mov    $0xaa0,%edx
 79a:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    base.s.size = 0;
 79f:	31 c9                	xor    %ecx,%ecx
 7a1:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 7a6:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7ac:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ae:	89 0d a4 0a 00 00    	mov    %ecx,0xaa4
    if(p->s.size >= nunits){
