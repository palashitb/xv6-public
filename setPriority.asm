...
int main(int argc, char *argv[]){
  ...
  45:	89 34 24             	mov    %esi,(%esp)
  48:	89 44 24 04          	mov    %eax,0x4(%esp)
  4c:	e8 1a 03 00 00       	call   36b <set_priority>
    exit();
 ...
 387:	89 d1                	mov    %edx,%ecx
{
 ...
 427:	e8 b7 fe ff ff       	call   2e3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a3:	e8 3b fe ff ff       	call   2e3 <write>
 ...
 504:	e8 da fd ff ff       	call   2e3 <write>
 ...
 520:	e8 be fd ff ff       	call   2e3 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5a5:	e8 39 fd ff ff       	call   2e3 <write>
      state = 0;
 ...
 5e0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5e3:	bb e0 07 00 00       	mov    $0x7e0,%ebx
        while(*s != 0){
 ...
 604:	e8 da fc ff ff       	call   2e3 <write>
        while(*s != 0){
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	75 d6                	jne    67f <free+0x4f>
  freep = p;
 6a9:	a3 80 0a 00 00       	mov    %eax,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 73e:	e8 ed fe ff ff       	call   630 <free>
  return freep;
 743:	a1 80 0a 00 00       	mov    0xa80,%eax
 ...
 76c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 76f:	a3 80 0a 00 00       	mov    %eax,0xa80
      return (void*)(p + 1);
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	b8 84 0a 00 00       	mov    $0xa84,%eax
 785:	ba 84 0a 00 00       	mov    $0xa84,%edx
 78a:	a3 80 0a 00 00       	mov    %eax,0xa80
    base.s.size = 0;
 78f:	31 c9                	xor    %ecx,%ecx
 791:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 796:	89 15 84 0a 00 00    	mov    %edx,0xa84
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 79c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79e:	89 0d 88 0a 00 00    	mov    %ecx,0xa88
    if(p->s.size >= nunits){
