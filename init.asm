   ...
   1:	b9 02 00 00 00       	mov    $0x2,%ecx
{
  ...
  13:	c7 04 24 78 08 00 00 	movl   $0x878,(%esp)
  ...
  47:	ba 80 08 00 00       	mov    $0x880,%edx
  ...
  af:	e8 cf 02 00 00       	call   383 <exit>
      exec("sh", argv);
  b4:	c7 44 24 04 64 0b 00 	movl   $0xb64,0x4(%esp)
  bb:	00 
  bc:	c7 04 24 a6 08 00 00 	movl   $0x8a6,(%esp)
  c3:	e8 f3 02 00 00       	call   3bb <exec>
      printf(1, "init: exec sh failed\n");
  c8:	c7 44 24 04 a9 08 00 	movl   $0x8a9,0x4(%esp)
  cf:	00 
  ...
  f0:	00 
  f1:	c7 04 24 78 08 00 00 	movl   $0x878,(%esp)
  f8:	e8 ce 02 00 00       	call   3cb <mknod>
    open("console", O_RDWR);
  fd:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 104:	00 
 105:	c7 04 24 78 08 00 00 	movl   $0x878,(%esp)
 ...
 447:	89 d1                	mov    %edx,%ecx
{
 ...
 495:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 498:	0f b6 92 d0 08 00 00 	movzbl 0x8d0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 6a3:	bb c8 08 00 00       	mov    $0x8c8,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7fe:	e8 ed fe ff ff       	call   6f0 <free>
  return freep;
 803:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 ...
 82c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 82f:	a3 6c 0b 00 00       	mov    %eax,0xb6c
      return (void*)(p + 1);
 ...
 83f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 840:	b8 70 0b 00 00       	mov    $0xb70,%eax
 845:	ba 70 0b 00 00       	mov    $0xb70,%edx
 84a:	a3 6c 0b 00 00       	mov    %eax,0xb6c
    base.s.size = 0;
 84f:	31 c9                	xor    %ecx,%ecx
 851:	bf 70 0b 00 00       	mov    $0xb70,%edi
    base.s.ptr = freep = prevp = &base;
 856:	89 15 70 0b 00 00    	mov    %edx,0xb70
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 85c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85e:	89 0d 74 0b 00 00    	mov    %ecx,0xb74
    if(p->s.size >= nunits){
