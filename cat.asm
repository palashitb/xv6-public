...
main(int argc, char *argv[])
{
  ...
  56:	c7 44 24 04 9b 08 00 	movl   $0x89b,0x4(%esp)
  5d:	00 
 ...
 447:	89 d1                	mov    %edx,%ecx
{
 ...
 495:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 498:	0f b6 92 b8 08 00 00 	movzbl 0x8b8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 6a3:	bb b0 08 00 00       	mov    $0x8b0,%ebx
        while(*s != 0){
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 767:	75 d6                	jne    73f <free+0x4f>
  freep = p;
 769:	a3 80 0b 00 00       	mov    %eax,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7fe:	e8 ed fe ff ff       	call   6f0 <free>
  return freep;
 803:	a1 80 0b 00 00       	mov    0xb80,%eax
 ...
 82c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 82f:	a3 80 0b 00 00       	mov    %eax,0xb80
      return (void*)(p + 1);
 ...
 845:	ba 84 0b 00 00       	mov    $0xb84,%edx
 84a:	a3 80 0b 00 00       	mov    %eax,0xb80
    base.s.size = 0;
 84f:	31 c9                	xor    %ecx,%ecx
 851:	bf 84 0b 00 00       	mov    $0xb84,%edi
    base.s.ptr = freep = prevp = &base;
 856:	89 15 84 0b 00 00    	mov    %edx,0xb84
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 85c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85e:	89 0d 88 0b 00 00    	mov    %ecx,0xb88
    if(p->s.size >= nunits){
