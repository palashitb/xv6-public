...
main(int argc, char **argv)
{
  ...
  39:	e8 85 02 00 00       	call   2c3 <exit>
    printf(2, "usage: kill pid...\n");
  3e:	c7 44 24 04 b8 07 00 	movl   $0x7b8,0x4(%esp)
  45:	00 
 ...
 387:	89 d1                	mov    %edx,%ecx
{
 ...
 3d5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 3d8:	0f b6 92 d4 07 00 00 	movzbl 0x7d4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5e3:	bb cc 07 00 00       	mov    $0x7cc,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 6c 0a 00 00    	mov    0xa6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 6c 0a 00 00    	mov    0xa6c,%edi
 ...
 73e:	e8 ed fe ff ff       	call   630 <free>
  return freep;
 743:	a1 6c 0a 00 00       	mov    0xa6c,%eax
 ...
 76c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 76f:	a3 6c 0a 00 00       	mov    %eax,0xa6c
      return (void*)(p + 1);
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	b8 70 0a 00 00       	mov    $0xa70,%eax
 785:	ba 70 0a 00 00       	mov    $0xa70,%edx
 78a:	a3 6c 0a 00 00       	mov    %eax,0xa6c
    base.s.size = 0;
 78f:	31 c9                	xor    %ecx,%ecx
 791:	bf 70 0a 00 00       	mov    $0xa70,%edi
    base.s.ptr = freep = prevp = &base;
 796:	89 15 70 0a 00 00    	mov    %edx,0xa70
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 79c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79e:	89 0d 74 0a 00 00    	mov    %ecx,0xa74
    if(p->s.size >= nunits){
