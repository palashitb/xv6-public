...
main(int argc, char *argv[])
{
  ...
  3d:	c7 44 24 04 dc 07 00 	movl   $0x7dc,0x4(%esp)
  44:	00 
  ...
  55:	eb df                	jmp    36 <main+0x36>
    printf(2, "Usage: rm files...\n");
  57:	c7 44 24 04 c8 07 00 	movl   $0x7c8,0x4(%esp)
  5e:	00 
 ...
 397:	89 d1                	mov    %edx,%ecx
{
 ...
 3e5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 3e8:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5f3:	bb f5 07 00 00       	mov    $0x7f5,%ebx
        while(*s != 0){
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	75 d6                	jne    68f <free+0x4f>
  freep = p;
 6b9:	a3 94 0a 00 00       	mov    %eax,0xa94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 94 0a 00 00    	mov    0xa94,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 94 0a 00 00    	mov    0xa94,%edi
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	a1 94 0a 00 00       	mov    0xa94,%eax
 ...
 77c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 77f:	a3 94 0a 00 00       	mov    %eax,0xa94
      return (void*)(p + 1);
 ...
 78f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 790:	b8 98 0a 00 00       	mov    $0xa98,%eax
 795:	ba 98 0a 00 00       	mov    $0xa98,%edx
 79a:	a3 94 0a 00 00       	mov    %eax,0xa94
    base.s.size = 0;
 79f:	31 c9                	xor    %ecx,%ecx
 7a1:	bf 98 0a 00 00       	mov    $0xa98,%edi
    base.s.ptr = freep = prevp = &base;
 7a6:	89 15 98 0a 00 00    	mov    %edx,0xa98
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7ac:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ae:	89 0d 9c 0a 00 00    	mov    %ecx,0xa9c
    if(p->s.size >= nunits){
