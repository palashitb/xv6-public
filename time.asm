...
main(int argc, char *argv[])
{
  ...
  42:	c7 44 24 04 b8 07 00 	movl   $0x7b8,0x4(%esp)
  49:	00 
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5e3:	bb ea 07 00 00       	mov    $0x7ea,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 76c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 76f:	a3 88 0a 00 00       	mov    %eax,0xa88
      return (void*)(p + 1);
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 785:	ba 8c 0a 00 00       	mov    $0xa8c,%edx
 78a:	a3 88 0a 00 00       	mov    %eax,0xa88
    base.s.size = 0;
 78f:	31 c9                	xor    %ecx,%ecx
 791:	bf 8c 0a 00 00       	mov    $0xa8c,%edi
    base.s.ptr = freep = prevp = &base;
 796:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 79c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79e:	89 0d 90 0a 00 00    	mov    %ecx,0xa90
    if(p->s.size >= nunits){
